...
public class Deck {
    ...
    //keet this comment i need it for reference
    /*
    public static void main(String[] args) {
        ...
        int playerAddedValue = playerValue + playerValueHidden;

        //displays the values
        //not for final product
        System.out.println("the computers shown value is " + compValue);
        System.out.println("the computers hidden value is " + compValueHidden);
        System.out.println("the players shown value is " + playerValue);
        System.out.println("the player hidden value is " + playerValueHidden);

        //displays total value for computer and player
        System.out.println("the computers total value is " + compAddedValue);
        System.out.println("the players total value is " + playerAddedValue);
        //example of how this will be used...
        //player chooses to get card
        //player gets random card
        //add that card to player added value / playerAddedValue = playerAddedValue+newRandomCard
        //if(player added value > 21)
        //player loses


        System.out.println("the cards are " + compCard1 + compCard2Hidden + playerCard1 + playerCard2Hidden);
